...
if __name__ == '__main__':
    ...
    theta, intercept, sum_j = fit(x, y, alpha=0.0001, max_iter=40000)
    ...
    x_hat.shape = -1, 1
    y_hat = model.predict(poly.transform(x_hat))
    y_hat2 = predict_X(poly.transform(x_hat), theta, intercept)
