...
# filename = 'D:\\ifchange\\neural_sequence_labeling\\data\\icdc_10.datacharacter.txtcharacter_all.zip'


# filename='/opt/userhome/kdd_zengxiangyun/code/GloVe-1.2/icdc_10.datacharacter.txtcharacter_all.zip'
